...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference("Boat.count") do
      post boats_url, params: { boat: { anno: @boat.anno, descrizione: @boat.descrizione, lunghezza: @boat.lunghezza, nome: @boat.nome, porto: @boat.porto, prezzo: @boat.prezzo, tipo: @boat.tipo } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { anno: @boat.anno, descrizione: @boat.descrizione, lunghezza: @boat.lunghezza, nome: @boat.nome, porto: @boat.porto, prezzo: @boat.prezzo, tipo: @boat.tipo } }
