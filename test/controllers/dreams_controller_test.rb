...
class DreamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dream" do
    assert_difference("Dream.count") do
      post dreams_url, params: { dream: { descrizione: @dream.descrizione, nome: @dream.nome } }
    end
  ...
  test "should update dream" do
    patch dream_url(@dream), params: { dream: { descrizione: @dream.descrizione, nome: @dream.nome } }
